...
import { ArrayObject, BooleanObject, BuiltinFunctionObject, ClassifiedObject, ConceptObject, ErrorObject, Float, GraphObject, 
    Hash, Integer, LambdaFunction, PureFunction, ReturnValue, StreamObject, StringObject, WheelObject } 
                                                    from "wrapt.co_re/src/Model [╍⬡╍ꙮ╍▦╍]/object/1_0_object";
import { TRUE, FALSE, NULL }                        from "wrapt.co_re/src/Model [╍⬡╍ꙮ╍▦╍]/object/1_1_object.singleton";

import { Environment, NewEnclosedEnvironment }      from "wrapt.co_re/src/Model [╍⬡╍ꙮ╍▦╍]/object/1_4_0_environment";
import { EObject, FunctionObject, InMemoryScalar }  from "wrapt.co_re/src/Model [╍⬡╍ꙮ╍▦╍]/object/0_1_object-structure";
